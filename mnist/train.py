...
def main():
    ...
    optimizer = WrappedOptimizer(torch.optim.SGD, history_file="raid/mnist.hdf5")(net.parameters(), lr=0.01)
    ...
    for e in range(1):
        ...
        torch.save(net.state_dict(), os.path.join(PATH, "mnist.pt"))
